...
$data = getFoodItem($_SESSION['USER_ID']);
?>
...
<html lang="en">
  ...
  <div class="col-md-12">
    <div class="row">
        ...
        <div class="col-sm-9">
              <h1 class="lead display-4">Manage Food Item</h1>
              <br>
              <hr>
              ...
              <table class="table table-striped">
               ...
               <tr>
                 ...
                 <td><?php echo $value['foodType'] ?></td>
                 <td>
                    <a href="UpdateFoodItem.php?id=<?php echo $value['id'];?>" class="btn btn-info">View</a>
                  </td>
                  <td>
                    <form class="form-inline" action="../process/manageFoodItem.php" method="post">
                    <input type="hidden" name="food_id" value="<?php echo $value['id'];  ?>">
                    <button class="btn btn-danger my-2 my-sm-0" type="submit"name="removeFoodItem">Remove</button>
                  </form>
                  </td>
               </tr>
               </tbody>

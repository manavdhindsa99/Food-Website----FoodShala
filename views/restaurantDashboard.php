  ...
  <div class="col-md-12">
    <div class="row">
        ...
        <div class="col-sm-9">
              ...
              <h3 class=" display-5">Add Food Item</h3>
              <br>
              <hr>
              <div class="card border-dark">
                <div class="card-body">
                <form action="../process/manageFoodItem.php" enctype="multipart/form-data" method="post" autocomplete="off">
                  <div class="form-group">
                      <label for="">Food Item Name<span class="text-danger">*</span></label>
                      <input type="text"class="form-control"  name="foodItemName" value="" required placeholder="Name">
                  </div>
                  <div class="form-group">
                      <label for="">Item Price<span class="text-danger">*</span></label>
                      <input type="number"class="form-control" min="10"  name="foodItemPrice" value="" required placeholder="Price">
                  </div>
                  <div class="form-group">
                  ...
                  <input type="hidden" name="restaurantID" value="<?php echo $_SESSION['USER_ID']; ?>">
                  <input type="hidden" name="restaurantName" value="<?php echo $_SESSION['restaurantName']; ?>">
                  <button class="btn btn-info btn-lg"type="submit" name="addFood">Add</button>
                </form>
                </div>
              </div>
        </div>

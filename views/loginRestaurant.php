  ...
  <div class="col-md-12">
    <div class="row">
        <div class="col-sm-5" id="part">
          <h1 class="text-white addRestaurantheading" style= "text-align:center;">Customers are waiting!</h1>
        </div>
        <div class="col-sm-7">
              <h1 class="lead display-4">Restaurant Login</h1>
              <br>
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group text-center">
                    ...
                    <br>
                    <br>
                    <a href="addRestaurant.php" class="text-muted">Get Your Restaurant Registered Here!</a>
                  </div>
                  </form>
                </div>
              </div>
